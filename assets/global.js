...
class DescWrapper extends HTMLElement {
  constructor(){
    super();
    this.title_area = this.querySelector('.title-area');
    this.content_area = this.querySelector('.content-area')
    this.title_area.addEventListener('click', this.toggleTab.bind(this));
  }

  toggleTab = () =>{
    this.toggleAttribute('open');
    if(this.hasAttribute('open')) {
      this.content_area.style.maxHeight = this.content_area.scrollHeight + 'px';
    }else {
      this.content_area.style.maxHeight = 0 + 'px';
    }
  }
}

customElements.define('desc-wrapper', DescWrapper);